...
var path = require('path'),
	...
	BkmExpressPaymentService = require('./services/BkmExpressPaymentService.js'),
	moment = require('moment');

var InitPayment = function (merchantId, successUrl, cancelUrl, saleAmount, cargoAmount, mobilSuccessURL, mobilCancelURL, requestSource, deviceType, osSource, userAgent) {
...
InitPayment.prototype.initPayment = function (banks, merchantPrivateKey, callback, wsdlLocation, bkmPublicKey) {
	...
	params["tns:initializePaymentWSRequest"] = params.initializePaymentWSRequest;
